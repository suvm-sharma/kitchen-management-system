...
import { IStaffDoc, IStaffModel } from './staff.interface';
 ...
 */
staffSchema.static('isEmailTaken', async function (email: string, excludeStaffId: mongoose.ObjectId): Promise<boolean> {
 ...
 * @returns {Promise<boolean>}
 */
staffSchema.method('isPasswordMatch', async function (password: string): Promise<boolean> {
  const staff = this;
